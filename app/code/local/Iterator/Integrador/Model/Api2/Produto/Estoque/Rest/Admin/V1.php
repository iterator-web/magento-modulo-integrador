...
class Iterator_Integrador_Model_Api2_Produto_Estoque_Rest_Admin_V1 extends Mage_Catalog_Model_Api2_Product_Rest {
    
    /**
     * Busca o estoque a partir do ID ou SKU do produto passado por parametro.
     *
    ...
    protected function _retrieve() {
        ...
        $stockItemModel = Mage::getModel('cataloginventory/stock_item')->loadByProduct($product);
        return $stockItemModel->getData();
    }
}
